  ...
  */
  ...
  /** 상품리스트 생성 **/
    ...
    function makeItem(prfLocation, prdCteCode, prdSelCode, prdCode, prdName, prdPrice, prdType, selShopName){
      let productItem = createDiv("","product__item cate", "", "");
      ...
      /* 가격 */
      let product__price__div = createDiv("","product__price__div cate","","");
      ...
      let product__etc__div = createDiv("","product__etc__div cate","","");
